    ...
    <section className="py-12 px-8 lg:py-24">
      <div className="container max-w-screen-lg mx-auto">
        <div className="container mx-auto mb-20 text-center">
          ...
          <Typography 
            variant="lead"
            className="mx-auto w-full px-4 font-normal !text-gray-500 lg:w-8/12"   placeholder=""
            onPointerEnterCapture={() => {}}
            onPointerLeaveCapture={() => {}}          >
          ...
          <CardBody className="w-full lg:gap-10 h-full lg:!flex justify-between "   placeholder=""
            ...
            <div className="w-full mb-10 lg:mb-0">
              <Typography
                variant="h3"
                color="blue-gray"
                className="mb-4 font-bold lg:max-w-xs"   placeholder=""
            onPointerEnterCapture={() => {}}
            onPointerLeaveCapture={() => {}}              >
            ...
            onPointerLeaveCapture={() => {}}>
              ...
              <Typography
                variant="small"
                className="font-normal mb-5 !text-gray-500"   placeholder=""
            onPointerEnterCapture={() => {}}
            onPointerLeaveCapture={() => {}}              >
                Marketing @ APPLE INC.
              </Typography>
              <div className="flex items-center gap-4">
                <Avatar
                  ...
                  onClick={() => setActive(1)}  placeholder=""
            onPointerEnterCapture={() => {}}
            onPointerLeaveCapture={() => {}}                />
                ...
                <Avatar
                  ...
                  onClick={() => setActive(2)}  placeholder=""
            onPointerEnterCapture={() => {}}
            onPointerLeaveCapture={() => {}}                />
                ...
                <Avatar
                  ...
                  onClick={() => setActive(3)}  placeholder=""
            onPointerEnterCapture={() => {}}
            onPointerLeaveCapture={() => {}}                />
              </div>
            </div>
